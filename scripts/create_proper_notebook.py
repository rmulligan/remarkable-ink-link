...
def create_proper_notebook():
    ...
    try:
        ...
        with open(page_path, 'w') as f:
            f.write("""This is a test query for the Claude Penpal service.
                ...
                with zipfile.ZipFile(notebook_path, 'r') as zip_ref:
                    ...
                    for file_name in zip_ref.namelist():
                        with zip_ref.open(file_name) as f:
                            content = f.read()
                            logger.info(f"File: {file_name}, Size: {len(content)} bytes")
...
if __name__ == "__main__":
    if create_proper_notebook():
        print(f"Successfully created and uploaded proper test notebook '{NOTEBOOK_NAME}'")
