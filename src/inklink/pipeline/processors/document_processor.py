...
class DocumentProcessor(Processor):
    ...
    def process(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            context.add_error(f"Failed to generate document: {str(e)}", processor=str(self))
    ...
    def _process_pdf_document(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            context.add_error(f"Failed to create PDF document: {str(e)}", processor=str(self))
    ...
    def _process_web_document(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            context.add_error(f"Failed to create web document: {str(e)}", processor=str(self))
