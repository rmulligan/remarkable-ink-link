...
import rmscene
from rmscene.scene_stream import simple_text_document, TaggedBlockWriter, SceneInfo
import tempfile
import os
...
with open(tmp_path, 'wb') as f:
    ...
    from rmscene.scene_stream import write_blocks, build_tree
