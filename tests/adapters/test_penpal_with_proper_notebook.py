...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test Claude Penpal Service with proper notebook")
    parser.add_argument("--notebook-name", type=str, default="Tagged_Test_Notebook", help="Notebook name to test with")
    ...
    logger.info(f"Found notebook: {target_notebook.get('VissibleName')} (ID: {target_notebook.get('ID')})")
