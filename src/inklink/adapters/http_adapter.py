...
class HTTPAdapter(Adapter):
    ...
    def post(self, 
        ...
        Returns:
            Tuple of (success, response_or_error)
        """
        return self._request("POST", endpoint, data=data, json=json, params=params, headers=headers, timeout=timeout)
    ...
    def put(self, 
        ...
        Returns:
            Tuple of (success, response_or_error)
        """
        return self._request("PUT", endpoint, data=data, json=json, params=params, headers=headers, timeout=timeout)
        ...
        while attempts <= max_retries:
            try:
                ...
                if attempts <= max_retries:
                    ...
                    logger.warning(f"Request failed, retrying in {sleep_time} seconds: {str(e)}")
