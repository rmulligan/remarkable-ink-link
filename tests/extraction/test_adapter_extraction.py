...
def test_extraction_with_sample_file():
    ...
    # Path to sample file
    sample_file = os.path.join(project_root, "rmdoc_extract", "6aaaeaf7-6932-4643-ae39-2c880e094b0f.content")
    ...
    try:
        ...
        if strokes and len(strokes) > 0:
            print(f"✅ Successfully extracted {len(strokes)} strokes from the sample file")
            print("\nFirst stroke data:")
