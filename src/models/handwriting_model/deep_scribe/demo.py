...
def demo_from_file(model_path: str, file_path: str, device: str = "cuda" if torch.cuda.is_available() else "cpu"):
    """
    Demo using a file.
...
def demo_from_synthetic(model_path: str, device: str = "cuda" if torch.cuda.is_available() else "cpu"):
    """
...
def main():
    ...
    # Input arguments
    parser.add_argument("--model", type=str, default="checkpoints/best_model.pt", help="Path to model file")
