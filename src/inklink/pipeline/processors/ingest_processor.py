    ...
    def process(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            if not content_type or not title or not content:
                context.add_error("Missing required fields for ingestion", processor=str(self))
                return context
            ...
            context.add_error(f"Failed to process ingested content: {str(e)}", processor=str(self))
