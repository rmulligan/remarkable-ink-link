...
def create_handwritten_query_rm():
    ...
    def create_stroke(points_list):
        ...
        for x, y, pressure, tilt_x, tilt_y, timestamp in points_list:
            stroke_data.extend(struct.pack('<ffffff', x, y, pressure, tilt_x, tilt_y, timestamp))
...
def create_test_notebook_with_query():
    ...
    temp_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_claude_real")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Test Claude Penpal Service with real Claude")
    parser.add_argument("--rmapi-path", type=str, help="Path to rmapi executable")
    parser.add_argument("--verbose", "-v", action="store_true", help="Enable verbose logging")
    parser.add_argument("--mock", action="store_true", help="Use mock instead of real Claude")
