...
def extract_relationships(transcription: str, entities: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
...
def save_to_knowledge_graph(entities: List[Dict[str, Any]], relationships: List[Dict[str, Any]]) -> None:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Process handwritten notes using Claude vision")
    parser.add_argument("image_path", help="Path to the image of handwritten notes")
    parser.add_argument("--content-type", choices=["text", "math", "diagram", "mixed"], 
                      default="mixed", help="Type of content in the image")
