...
class HandwritingRecognitionCache:
    ...
    def _get_cache_path(self, stroke_hash: str, content_type: str, language: str) -> str:
        """
    ...
    def get(self, strokes: List[Dict[str, Any]], content_type: str, language: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def put(self, strokes: List[Dict[str, Any]], content_type: str, language: str, result: Dict[str, Any]) -> bool:
        """
    ...
    def invalidate(self, strokes: List[Dict[str, Any]], content_type: str, language: str) -> bool:
        """
