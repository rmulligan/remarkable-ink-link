...
class IQRCodeService(ABC):
    ...
    @abstractmethod
    def generate_custom_qr(self, url: str, config: Dict[str, Any], svg: bool = False) -> Tuple[str, str]:
...
class IPDFService(ABC):
    ...
    @abstractmethod
    def generate_index_notebook(self, pages: List[Dict[str, Any]], output_path: str, graph_title: str = "Index Node Graph") -> bool:
