...
AUTH_CONFIG = {
    # Credential storage
    "CREDENTIAL_STORAGE_DIR": os.environ.get("LILLY_CREDENTIAL_STORAGE_DIR", 
                                           str(Path.home() / ".lilly" / "credentials")),
    ...
    "PROTON_BRIDGE_IMAP_PORT": int(os.environ.get("LILLY_PROTON_BRIDGE_IMAP_PORT", 1143)),
    "PROTON_BRIDGE_SMTP_PORT": int(os.environ.get("LILLY_PROTON_BRIDGE_SMTP_PORT", 1025)),
    "PROTON_BRIDGE_CALDAV_PORT": int(os.environ.get("LILLY_PROTON_BRIDGE_CALDAV_PORT", 8443)),
    ...
    "GOOGLE_REDIRECT_URI": os.environ.get("LILLY_GOOGLE_REDIRECT_URI", "http://localhost:8080/oauth2callback"),
    ...
    for key in AUTH_CONFIG:
        ...
        if env_var in os.environ:
            ...
            if isinstance(AUTH_CONFIG[key], int):
                ...
                AUTH_CONFIG[key] = os.environ[env_var].lower() in ('true', 'yes', '1', 't', 'y')
