...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Download, modify, and re-upload a notebook")
    parser.add_argument("--notebook", type=str, default="Testing Notebook", help="Name of existing notebook to download")
    parser.add_argument("--new-name", type=str, help="New name for the re-uploaded notebook")
