...
def ensure_drawj2d_available() -> bool:
    ...
    try:
        ...
        if drawj2d_path and os.path.exists(drawj2d_path) and os.access(drawj2d_path, os.X_OK):
            return True
...
def create_hcl_from_markdown(markdown_path: str, output_dir: str, title: str = None) -> Tuple[bool, str]:
    """
