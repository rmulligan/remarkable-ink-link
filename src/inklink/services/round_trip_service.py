...
class RoundTripService:
    ...
    def __init__(self, 
        ...
        self.document_service = document_service or DocumentService(
            self.temp_dir, 
            CONFIG.get("DRAWJ2D_PATH")
        )
        self.remarkable_service = remarkable_service or RemarkableService(
            CONFIG.get("RMAPI_PATH"), 
            CONFIG.get("RM_FOLDER")
        )
    
    def process_handwritten_query(self, rm_file_path: str) -> Tuple[bool, Dict[str, Any]]:
            ...
            rm_path = self.document_service.create_rmdoc_from_content(
                ...
                content={
                    ...
                    "structured_content": [
                        ...
                        {"type": "paragraph", "content": f"Your Question: {recognized_text}"},
