...
class RemarkableHandwritingRecognizer:
    ...
    def recognize_from_strokes(self, strokes: List[Dict[str, Any]]) -> Tuple[str, float]:
        """
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Recognize handwriting from reMarkable files")
    ...
    parser.add_argument("--save-strokes", action="store_true", help="Save extracted strokes to JSON")
    ...
    recognizer = RemarkableHandwritingRecognizer(
