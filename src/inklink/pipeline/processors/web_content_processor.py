...
class WebContentProcessor(Processor):
    ...
    def process(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            context.add_error(f"Failed to process web content: {str(e)}", processor=str(self))
    ...
    def _process_webpage(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            if not content:
                context.add_error(f"Failed to scrape web content: {url}", processor=str(self))
                return context
            ...
            context.add_error(f"Failed to process webpage: {str(e)}", processor=str(self))
