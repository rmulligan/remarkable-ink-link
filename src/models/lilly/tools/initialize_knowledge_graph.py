...
def create_entity_types(entity_types: List[str]) -> None:
    ...
    entities_json = json.dumps([{"name": et, "entityType": "EntityType"} for et in entity_types])
...
"""
    ...
    rel_json = json.dumps([{"name": rt, "entityType": "RelationshipType"} for rt in relationship_types])
