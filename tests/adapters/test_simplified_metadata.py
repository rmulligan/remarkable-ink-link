...
def main():
    ...
    parser.add_argument("--notebook-name", type=str, default="Simple Metadata Test", help="Name for the test notebook")
    ...
    temp_dir, content_file_path, metadata_file_path, notebook_id = create_test_notebook()
