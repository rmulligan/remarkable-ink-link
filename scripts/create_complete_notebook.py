...
def create_complete_notebook():
    ...
    try:
        ...
        debug_copy = os.path.join(debug_dir, f"{NOTEBOOK_NAME}_complete_{int(time.time())}.rmdoc")
        import shutil
...
if __name__ == "__main__":
    if create_complete_notebook():
        print(f"Successfully created and uploaded complete test notebook '{NOTEBOOK_NAME}'")
