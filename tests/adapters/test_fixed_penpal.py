...
def main():
    ...
    parser.add_argument("--notebook", type=str, default="Testing Notebook", help="Name of notebook to test with")
    ...
    try:
        ...
        if service.method_calls:
            ...
            logger.warning("No service methods were called, notebook might not have tagged pages")
            return False
