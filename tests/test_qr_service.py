...
class MockQRCodeAdapter:
    ...
    def generate_svg_qr_code(self, data, filename=None, custom_config=None):
        """Mock implementation of generate_svg_qr_code."""
        self.generate_svg_qr_code_calls.append(
            {"data": data, "filename": filename, "custom_config": custom_config}
        )
...
def test_real_adapter(tmp_path):
    ...
    custom_config = {"version": 2, "box_size": 15, "border": 2}
