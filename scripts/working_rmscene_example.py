...
try:
    ...
    from rmscene.scene_stream import SceneTree, write_blocks, read_tree  # noqa: E402
    from rmscene.scene_stream import (
        SceneInfo, MainBlockInfo, SceneTreeBlock, 
        TreeNodeBlock, SceneLineItemBlock
    )
