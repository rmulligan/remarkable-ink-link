...
class HandwritingAdapter(Adapter):
    ...
    def initialize_sdk(self, application_key: str, hmac_key: str) -> bool:
        ...
        try:
            ...
            configuration.setStringProperty("configuration-manager.application-key", application_key)
        ...
        try:
            ...
            for stroke in strokes:
                ...
                for i, point in enumerate(stroke["points"]):
                    ...
                    ink_point.x = point["x"]
                    ink_point.y = point["y"]
                    ink_point.pressure = point["pressure"] if "pressure" in point else 1.0
                    ink_point.timestamp = point["timestamp"] if "timestamp" in point else 0
    ...
    def recognize_handwriting(self, 
        ...
        try:
            ...
            # Import SDK
            try:
                from iink.iink import InkModel, ContentBlock, ContentPackage, ContentPart
