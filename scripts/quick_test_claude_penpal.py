...
def main():
    ...
    test_notebook_dir = os.path.join(os.path.expanduser("~/dev/Lilly/Work/Testing_Notebook"))
    ...
    notebook_id = os.path.basename(os.path.dirname(content_file)) if os.path.dirname(content_file) else None
