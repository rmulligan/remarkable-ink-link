...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Simple test for Claude Penpal Service"
    )
    parser.add_argument(
        "--notebook-id", type=str, required=True, help="Notebook ID to test with"
    )
    ...
    logger.info(
        f"Found notebook: {target_notebook.get('VissibleName')} (ID: {args.notebook_id})"
    )
