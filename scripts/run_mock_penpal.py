...
def process_notebook(notebook_dir):
    ...
    for query_page in query_pages:
        ...
        add_response_to_notebook(content_data, content_file, query_page, claude_response)
...
def add_response_to_notebook(content_data, content_file, query_page, response_text):
    ...
    if query_idx >= 0:
        ...
        if notebook_id:
            ...
            response_rm_file = os.path.join(extract_dir, notebook_id, f"{response_page_id}.rm")
