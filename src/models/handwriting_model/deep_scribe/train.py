...
def main():
    ...
    parser.add_argument("--synthetic", action="store_true", help="Create and use synthetic data")
    parser.add_argument("--num-synthetic", type=int, default=5000, help="Number of synthetic samples")
    
    # Model arguments
    parser.add_argument("--hidden-dim", type=int, default=128, help="Hidden dimension of LSTM")
