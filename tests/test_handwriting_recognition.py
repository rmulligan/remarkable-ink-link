...
def test_convert_to_iink_format(mock_strokes, mock_handwriting_adapter):
    ...
    mock_handwriting_adapter.convert_to_iink_format.assert_called_once_with(mock_strokes)
...
def test_extract_strokes(mock_handwriting_adapter):
    ...
    # Verify the adapter was called
    mock_handwriting_adapter.extract_strokes_from_rm_file.assert_called_once_with(file_path)
...
def test_extract_strokes_empty_file(tmp_path, mock_handwriting_adapter):
    ...
    # Verify the adapter was called
    mock_handwriting_adapter.extract_strokes_from_rm_file.assert_called_once_with(str(empty_file))
...
def test_initialize_iink_sdk(mock_handwriting_adapter):
    ...
    # Verify the adapter was called
    mock_handwriting_adapter.initialize_sdk.assert_called_once_with("new_app_key", "new_hmac_key")
...
def test_recognize_handwriting(mock_handwriting_adapter, mock_strokes):
    ...
    # Verify the adapter was called
    mock_handwriting_adapter.recognize_handwriting.assert_called_once_with(iink_data, "Text", "en_US")
...
def test_export_content(mock_handwriting_adapter):
    ...
    # Verify the adapter was called
    mock_handwriting_adapter.export_content.assert_called_once_with(content_id, format_type)
