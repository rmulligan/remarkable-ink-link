...
try:
    import rmscene
    logger.info(f"rmscene version: {rmscene.__version__ if hasattr(rmscene, '__version__') else 'unknown'}")
    ...
    try:
        ...
        logger.info("Successfully imported read_tree and write_tree from rmscene.scene_stream")
    except ImportError as e:
...
try:
    ...
    if line.points:
        print(f"  First point: x={line.points[0].x}, y={line.points[0].y}, pressure={line.points[0].pressure}, t={line.points[0].t}")
