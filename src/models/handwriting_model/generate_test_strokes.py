...
CHAR_TEMPLATES = {
    'a': [
        ...
        [(10, 15), (8, 12), (10, 8), (15, 7), (18, 9), (20, 13), (18, 17), (15, 18), (12, 17)],
    ...
    'e': [
        # Single stroke
        [(20, 15), (15, 18), (10, 15), (8, 10), (10, 7), (15, 5), (20, 7), (8, 12), (20, 12)]
    ],
    'f': [
        # First stroke - vertical line
        [(15, 5), (15, 20)],
    ...
    'g': [
        ...
        [(20, 10), (15, 8), (10, 10), (8, 15), (10, 20), (15, 22), (20, 20), (20, 25), (15, 28), (10, 25)]
    ],
    'h': [
    ...
    'o': [
        ...
        [(15, 8), (10, 10), (8, 15), (10, 20), (15, 22), (20, 20), (22, 15), (20, 10), (15, 8)]
    ],
    'p': [
        # First stroke - vertical
        [(10, 10), (10, 25)],
...
def add_noise_to_point(point: Tuple[float, float], noise_level: float = 0.5) -> Tuple[float, float]:
    """
...
def generate_stroke_data(text: str, noise_level: float = 0.5) -> List[Dict[str, Any]]:
    ...
    for char in text.lower():
        ...
        for stroke_points in char_strokes:
            ...
            pressures = [min(1.0, max(0.3, base_pressure + np.random.normal(0, 0.05))) for _ in range(n_points)]
            
            # Generate timestamps (continuous)
            # Each point takes 10-20ms
            point_times = [timestamp + i * (10 + np.random.randint(10)) for i in range(n_points)]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate test stroke data for handwriting recognition")
    parser.add_argument("text", help="Text to convert to strokes")
    parser.add_argument("--output", "-o", default="test_strokes.json", help="Output JSON file path")
    parser.add_argument("--noise", "-n", type=float, default=0.5, help="Noise level (0-1)")
    parser.add_argument("--visualize", "-v", action="store_true", help="Visualize generated strokes")
