...
def create_test_rm_file():
    ...
    # Combine all data
    rm_data = (header + num_layers + num_strokes + pen + color + unknown1 + 
              width + unknown2 + num_points + point1 + point2 + point3)
...
def create_tagged_notebook():
    ...
    temp_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_tagged_notebook")
