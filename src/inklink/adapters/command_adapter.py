...
class CommandAdapter(Adapter):
    ...
    def ping(self) -> bool:
        ...
        return os.path.exists(self.executable_path) and os.access(self.executable_path, os.X_OK)
    ...
    def run_command(self, 
                  ...
                  cwd: str = None) -> Tuple[bool, Union[str, Dict[str, Any]]]:
        """
        ...
        try:
            ...
            if not self.ping():
                return False, f"Executable not found or not executable: {self.executable_path}"
            ...
            if result.returncode == 0:
                ...
                # Error
                error = result.stderr if capture_output else f"Command failed with exit code {result.returncode}"
                return False, error
    ...
    def run_with_retry(self, 
                     ...
                     max_retries: int = 3,
                     retry_delay: int = 2,
                     **kwargs) -> Tuple[bool, Union[str, Dict[str, Any]]]:
        """
    ...
    def parse_key_value_output(self, output: str, delimiter: str = ":") -> Dict[str, str]:
        """
