...
class GoogleAPIAdapter(Adapter):
        ...
        try:
            ...
            if not self.creds or not self.creds.valid:
                if self.creds and self.creds.expired and self.creds.refresh_token:
                    ...
                    logger.error("No credentials available for Google API authentication")
                    return
    ...
    def extract_doc_id(self, url_or_id: str) -> str:
        ...
        try:
            ...
            if parsed_url.hostname == "docs.google.com":
                ...
                segments = path.split("/")
                if (len(segments) >= 4 and segments[1] == "document" 
                    and segments[2] == "d" and segments[3]):
                    return segments[3]
                
                # Try edit URL pattern: '/document/d/e/<ID>/...'
                if (len(segments) >= 5 and segments[1] == "document" 
                    and segments[2] == "d" and segments[3] == "e" and segments[4]):
                    return segments[4]
    ...
    def list_documents(self, 
                     ...
                     max_results: int = 10) -> Tuple[bool, List[Dict[str, Any]]]:
        """
