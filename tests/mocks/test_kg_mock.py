...
class MockKnowledgeGraphService(IKnowledgeGraphService):
    ...
    def extract_relationships(self, content: str) -> List[Dict[str, Any]]:
        ...
        return [
            {"from_id": "entity1", "to_id": "entity2", "type": "MENTIONS", "source": "test"}
        ]
    ...
    def add_relationship(self, relationship: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        """Mock relationship addition."""
        self.relationships.append(relationship)
        return True, {"id": f"r-{len(self.relationships)}", "type": relationship.get("type", "Unknown")}
